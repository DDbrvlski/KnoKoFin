...
{
    public class TransactionServiceConfiguration : IEntityTypeConfiguration<DictionaryTransactionService>
    {
        public void Configure(EntityTypeBuilder<DictionaryTransactionService> builder)
        {
            builder.ToTable("transaction_services", "dictionaries");
